...
const Banner = () => {
  return (
    <section className='bg-linear-to-r relative text-white flex justify-between px-2 items-center py-2 from-primary/80 md:h-52 md:px-40 h-40 overflow-hidden to-secondary/80 w-full rounded-lg'> 
    ...
    <div className=''>
        ...
        <h2 className='text-2xl font-semibold md:text-6xl'><span className='  font-extrabold'>30% <span className='text-sm md:text-3xl'>off</span></span> Every Products</h2>
